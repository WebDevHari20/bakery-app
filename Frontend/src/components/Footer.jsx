...
const Footer = () => {
  ...
  return (
    <footer className='bg-neutral-900 pt-16 pb-8 px-4 sm:px-6 lg:px-16 text-white'>
      <div className='mx-auto max-w-7xl'>
        <div className='grid grid-cols-1 gap-12 md:grid-cols-4'>
          ...
          <div className='md:col-span-2'>
            ...
            <div className='mt-6 flex gap-4'>
              {/* Instagram Icon - Great for your cover songs & cake photos */}
              <a href='https://www.instagram.com/sowmyas_cakes_n_bakes?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==' className='flex h-10 w-10 items-center justify-center rounded-full bg-white/5 transition-colors hover:bg-yellow-500 hover:text-neutral-900'>
          ...
          <div>
            ...
            <ul className='mt-6 space-y-4 text-sm font-medium text-neutral-500'>
        ...
        {/* Bottom Bar */}
        <div className='mt-16 border-t border-white/5 pt-8 flex flex-col items-center justify-between gap-4 md:flex-row'>
